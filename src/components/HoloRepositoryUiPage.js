...
class HoloRepositoryUiPage extends Component {
    render() {
        return (
            <div>
                        ...
                        <Grid.Row>
                            {isBrowser ? <Grid.Column width= '2' align='middle'>
                                <StickyBox offsetTop={70} >
                                    <Button as={Link} to={{ pathname : '/intro'}} style={{marginTop: 10}}>
...
export default HoloRepositoryUiPage;
