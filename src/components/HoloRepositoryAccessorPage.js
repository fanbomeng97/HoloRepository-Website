...
class HoloRepositoryAccessorPage extends Component {
    render() {
        return (
            <div>
                ...
                <div id="title" style={{
                    ...
                    <Segment style = {{
                        ...
                        <Header
                            textAlign='center'
                            content='HoloStorage and Accessor'
                        ...
                        <Grid.Row>
                            {isBrowser ? <Grid.Column width= '2' align='middle'>
                                <StickyBox offsetTop={70} >
                                    <Button as={Link} to={{ pathname : '/intro/pipeline'}} style={{ marginTop: 10}} >
                            ...
                            {isBrowser || isTablet  ? <Grid.Column width= '2' align='middle'>
                                <StickyBox offsetTop={70} >
                                    <Button as={Link} to={{ pathname : '/intro/hololensapp'}} style={{ marginTop: 10}} >
...
export default HoloRepositoryAccessorPage;
